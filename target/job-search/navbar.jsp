...
<div class="w3-bar w3-white w3-large">
    ...
    <a href="/workers" class="w3-bar-item w3-button w3-mobile">Find a worker</a>
    <a href="/vacancies" class="w3-bar-item w3-button w3-mobile">Find a job</a>
    <a href="/createResume" class="w3-bar-item w3-button w3-mobile">Leave a resume</a>
    <a href="<%= "/person/" + user.getUsername()%>" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">Your room</a>
</div>
</body>
</html>
